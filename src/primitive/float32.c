...
value float32_to_float64(value v) { return copy_double((double)Float_val(v)); }

value float32_zero() { return copy_float(0); }

value float32_one() { return copy_float(1); }
...
value float32_neg(value v) { return copy_float(-Float_val(v)); }

value float32_is_nan(value v) { return Val_bool(isnan(Float_val(v))); }

value float32_compare(value v1, value v2) {
  float val1 = Float_val(v1);
  float val2 = Float_val(v2);
